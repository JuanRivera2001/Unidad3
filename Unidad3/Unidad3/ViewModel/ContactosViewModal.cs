...
namespace Unidad3.ViewModel
{
    class ContactosViewModal : BaseViewModel
    {
        ...
        public ICommand CreateCommand
        {
            get
            {
                return new RelayCommand(CreateContactMethod);
            }
            set { }
        }
        ...
        public async void CreateContactMethod()
        {
            ...
            await App.Db.SaveModelAsync<ContactosModel>(contact, true);
            await Application.Current.MainPage.DisplayAlert("OK", " Contacto Creado", "OK");
            await Application.Current.MainPage.Navigation.PushAsync(new Landing(), true);
        }
